...
[인사이트 분류 기준 — 반드시 아래 7개 중 하나만 사용]
repeatPatterns의 issueCategory는 반드시 아래 7개 카테고리 중 하나로 분류:
전략 / 조직 / 실행 / 시장 / 제품 / 재무 / 멘토링
(예: 기술적 이슈 → "제품", 데이터 인프라 → "실행", 채용 → "조직". "기술", "데이터" 등 위 7개 외 카테고리 사용 금지)
